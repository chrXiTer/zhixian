...
if(isWeiXin())
    ...
    <form id="formLogin" method="post" style="margin: 0 auto; padding:10px">
        ...
        <a href="/Home/Account/Register?returnUrl=/Home/Account/Login?returnUrl=/Home/News" style="margin-left: 10px;">注册</a>
        <button type="submit" class="btn btn-default" style="margin-left: 80px;">登录</button>
        <span id="tips"></span>
    </form>
    </div><!--class="container body-content" -->
